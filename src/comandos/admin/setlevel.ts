...
export default {
  ...
  async execute({ sock, msg, args, groupId, replyJid }) {
    ...
    try {
      ...
      // Actualizar nivel y puntos mínimos del nivel usando docId correcto
      ...
      await sock.sendMessage(replyJid,
        formatSuccess(`${EMOJIS.STAR} Nivel de @${normalized} cambiado a ${level} - ${targetLevel.name}\n\nPuntos ajustados: ${targetLevel.minPoints}`),
