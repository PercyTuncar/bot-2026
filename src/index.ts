// ============================================================
// WhatsApp Bot - Entry Point (Baileys)
...
async function main() {
  try {
    ...
    // 3. Inicializar cliente de WhatsApp (Baileys)
    ...
    try {
      ...
      // 4. Configurar manejador de eventos
      ...
      // Wait for connection to stabilize and user info to be available
