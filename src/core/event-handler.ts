...
export class EventHandler {
  ...
  async handleMemberJoin(groupId: string, phone: string, contactFromNotification?: any) {
    try {
      ...
      // NOTA: La carga forzada de datos (forceLoadContactData) se realiza DENTRO de 
      // WelcomeService.sendWelcome() después del período de "Escribiendo..." (6s),
      // lo cual es más efectivo porque WhatsApp ya habrá tenido tiempo de sincronizar
      // los metadatos del usuario recién unido.
