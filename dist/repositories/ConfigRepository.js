...
export class ConfigRepository {
    static async getGlobal() {
        ...
        try {
            ...
            if (!result.points.name)
                result.points.name = 'puntos';
            if (!result.points.perMessages)
                result.points.perMessages = 10;
            if (result.points.enabled === undefined)
                result.points.enabled = true;
